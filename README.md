...
Meu nome é Arthur Castro.

Sou estudante de Análise e Desenvolvimento de Sistemas e desenvolvedor Front-end e Back-end em transição para Full Stack.

Desenvolvedor em formação, apaixonado por tecnologia, atualmente focado em JavaScript e iniciando estudos em Back-end com Node.js.

Sempre busco desenvolver projetos para praticar lógica de programação e criar soluções reais.
<br>
## Tecnologias:
